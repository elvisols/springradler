...
class DefaultItemServiceTest {
    ...
    void shouldCreateItem() {
        final CreateItemRequest createItemRequest = CreateItemRequest.builder().title("title").build();
        final ProductItem productItem = getProductItem();
        final Item item = getItem();
    ...
    void shouldUpdateItem() {
        final UpdateItemRequest updateItemRequest = UpdateItemRequest.builder().title("title").build();
        final ProductItem productItem = getProductItem();
        final Item item = getItem();
    ...
    private ProductItem getProductItem() {
        return ProductItem.builder().id(ITEM_ID).title("product title").build();
    }

    private Item getItem() {
        return Item.builder().id(ITEM_ID).title("product title").build();
    }
